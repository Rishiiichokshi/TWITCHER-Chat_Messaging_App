...
public class MainActivity extends BaseActivity  implements ConversionListener {
    ...
    private void setListeners() {
        ...
        //when user tap on the plus icon they will direct to user activity which i have made
        // with recycler view that contains list of user
        binding.fabNewChat.setOnClickListener(v ->
                startActivity(new Intent(getApplicationContext(), UsersActivity.class)));
    }

    private void loadUserDetails() {
        //setting the name via preference manager
    ...
    // to send message to a specific device
