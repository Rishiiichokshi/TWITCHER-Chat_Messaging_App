...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setListener();
        binding.myScrollBar.setVerticalScrollBarEnabled(false);
    }
...
//                     when signUp completed make the progressbar visible again and get
//                     all the data that user has entered through the sharedPreferences(Preference Manager),
//                     and go the new Activity
                    loading(false);
    ...
    //to display the image we selected from the gallery
